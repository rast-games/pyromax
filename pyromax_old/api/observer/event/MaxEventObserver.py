...
from pyromax_old.exceptions import AnnotationHandlerError
from pyromax_old.api.observer import ObserverPattern

from pyromax_old.api.observer import Handler
from pyromax_old.api.observer import Router

if TYPE_CHECKING:
    from pyromax_old.filters import Filter
    from pyromax_old.api import MaxApi
    from pyromax_old.types import Update
